...
function SignUpPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$styles$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/api/auth/signup`, {
                method: 'POST',
                headers: {
...
_s(SignUpPage, "/MROjzzQyVLHwhqLZ5crclV/vZM=", false, function() {
    return [
