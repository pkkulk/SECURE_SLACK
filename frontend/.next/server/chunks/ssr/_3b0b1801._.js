...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$styles$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]}/api/auth/login`, {
            method: "POST",
            headers: {
